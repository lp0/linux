 ...
 */
extern struct bcm_mbox_chan *bcm_mbox_get(struct device_node *node, const char *pmbox, const char *pchan);
...
extern int bcm_mbox_call(struct bcm_mbox_chan *mbox, u32 out_data28, u32 *in_data28);
